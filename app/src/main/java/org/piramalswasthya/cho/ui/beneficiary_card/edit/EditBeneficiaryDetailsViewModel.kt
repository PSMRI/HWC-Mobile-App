...
class EditBeneficiaryDetailsViewModel @Inject constructor(
    ...
    fun setPatientInfo(patient: PatientDisplayWithVisitInfo) {
        ...
        // Initialize field values from patient
        ...
        // Calculate age components from DOB if available
        ...
        // Update filtered list based on patient's gender, age, and marital status
    ...
    fun saveChanges() {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                // Update the patientInfo LiveData with updated patient
