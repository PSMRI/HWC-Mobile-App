...
//
    ...
    private var _prescriptions = MutableLiveData<List<PrescriptionItemDTO>>(null)
    val prescriptions: LiveData<List<PrescriptionItemDTO>>
        get() = _prescriptions
    ...
    suspend fun getPrescription(patientId: String) {
        withContext(Dispatchers.IO) {
            _prescriptions.postValue(benFlowRepo.pullPrescriptionListData(patientId)?.itemList ?: null)
        }
    }
//
