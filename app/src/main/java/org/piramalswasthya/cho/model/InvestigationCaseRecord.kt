...
data class InvestigationCaseRecord(
    ...
    @ColumnInfo(name = "counsellingProvidedList") val counsellingProvidedList: ArrayList<String>?,
    ...
    constructor(docData: DoctorDataDownSync, patient: Patient, benFlow: BenFlow) : this(
        ...
        counsellingProvidedList = docData.investigation?.counsellingProvidedList ?: arrayListOf(),
