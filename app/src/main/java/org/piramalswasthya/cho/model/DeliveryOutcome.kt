...
data class DeliveryOutcomeCache (
    ...
    var gestationalAgeAtDelivery: String? = null,
    var deliveryConductedBy: String? = null,
    var modeOfDelivery: String? = null,
    var indicationForLSCS: String? = null,
    var indicationForLSCSOther: String? = null,
    var privateHospitalName: String? = null,

    /** Mother's condition immediately post-delivery: Healthy/Stable, Complication (specify), Critical/ICU admission, Maternal Death */
    var motherCondition: String? = null,
    /** Comma-separated maternal complications when condition is Complication or Critical */
    var maternalComplications: String? = null,
    /** Mother currently admitted? Yes (Still in hospital) / No (Discharged) */
    var motherCurrentlyAdmitted: Boolean? = null,
...
//    var isActive: Boolean? = true,
    ...
    fun asPostModel(benId: Long) :DeliveryOutcomePost {
        return DeliveryOutcomePost(
            ...
            gestationalAgeAtDelivery = gestationalAgeAtDelivery,
            deliveryConductedBy = deliveryConductedBy,
            modeOfDelivery = modeOfDelivery,
            indicationForLSCS = indicationForLSCS,
            indicationForLSCSOther = indicationForLSCSOther,
            privateHospitalName = privateHospitalName,
            motherCondition = motherCondition,
            maternalComplications = maternalComplications,
            motherCurrentlyAdmitted = motherCurrentlyAdmitted,
            isDeath = isDeath,
...
data class DeliveryOutcomePost (
    ...
    val gestationalAgeAtDelivery: String? = null,
    val deliveryConductedBy: String? = null,
    val modeOfDelivery: String? = null,
    val indicationForLSCS: String? = null,
    val indicationForLSCSOther: String? = null,
    val privateHospitalName: String? = null,
    val motherCondition: String? = null,
    val maternalComplications: String? = null,
    val motherCurrentlyAdmitted: Boolean? = null,
    ...
    fun toDeliveryCache(patientID: String): DeliveryOutcomeCache {
        return DeliveryOutcomeCache(
            ...
            patientID = patientID,
            isActive = isActive,
            dateOfDelivery = dateOfDelivery?.let { getLongFromDate(it) },
            timeOfDelivery = timeOfDelivery,
            placeOfDelivery = placeOfDelivery,
            typeOfDelivery = typeOfDelivery,
            hadComplications = hadComplications,
            ...
            liveBirth = liveBirth,
            stillBirth = stillBirth,
            dateOfDischarge = dateOfDischarge?.let { getLongFromDate(it) },
            timeOfDischarge = timeOfDischarge,
            isJSYBenificiary = isJSYBenificiary,
            gestationalAgeAtDelivery = gestationalAgeAtDelivery,
            deliveryConductedBy = deliveryConductedBy,
            ...
            processed = "P",
            createdBy = createdBy,
            createdDate = createdDate?.let { getLongFromDate(it) } ?: System.currentTimeMillis(),
            updatedBy = updatedBy,
            updatedDate = updatedDate?.let { getLongFromDate(it) } ?: System.currentTimeMillis(),
