        ...
        return withContext(Dispatchers.IO) {
            ...
            unsyncedList.forEach { assessment ->
                ...
                if (patient?.beneficiaryID != null && patient.beneficiaryRegID != null) {
                    networkList.add(ElderlyHealthNetwork(patient.beneficiaryID.toString(), patient.beneficiaryRegID.toString(), assessment))
                }
            }
    ...
    suspend fun pullElderlyVisitsFromServer(): Boolean {
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                return@withContext pullElderlyVisitsFromServer()
            } catch (e: Exception) {
