...
class BlockMasterRepo @Inject constructor(private val blockMasterDao: BlockMasterDao, private val apiService: AmritApiService, private val userRepo: UserRepo ) {
    ...
    suspend fun blockMasterService(districtId : Int): NetworkResult<Map<Int, String>> {
...
//        }
    ...
    suspend fun getBlocksByDistrictIdAsMap(districtId: Int): Map<Int, String> {
        return blockMasterDao.getBlocks(districtId).associate { it -> it.blockID to it.blockName }
    }
