        ...
        return withContext(Dispatchers.IO) {
            ...
            unsyncedList.forEach { assessment ->
                ...
                if (patient?.beneficiaryID != null && patient.beneficiaryRegID != null) {
                    networkList.add(OralHealthNetwork(patient.beneficiaryID.toString(), patient.beneficiaryRegID.toString(), assessment))
                }
            }
    ...
    suspend fun pullOralVisitsFromServer(): Boolean {
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                return@withContext pullOralVisitsFromServer()
            } catch (e: Exception) {
